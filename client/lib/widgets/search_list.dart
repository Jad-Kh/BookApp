...
class _SearchListState extends State<SearchList> {
 ...
 Future<List<Book>> getBooks() async {
    list = [];
           if(widget.index == 0) {
      response = await Dio().get('http://10.0.2.2:5050/api/books/' + widget.search);
    } else if(widget.index == 1) {
      response = await Dio().get('http://10.0.2.2:5050/api/books/title/' + widget.search);
    } else if(widget.index == 2) {
      response = await Dio().get('http://10.0.2.2:5050/api/books/publisher/' + widget.search);
    } else if(widget.index == 3) {
      response = await Dio().get('http://10.0.2.2:5050/api/books/author/' + widget.search);
    }
