                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        book.ratingaverage != 0.001 ?  book.ratingaverage.toString() + "   | " : "??    | ",
                                        style: TextStyle(
                                          color: Theme.of(context)
                                              .secondaryHeaderColor,
                                          fontSize: 15.0,
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 3.0),
                                      child: Text(
                                        book.ratingnumber != 0 ? book.ratingnumber.toString() : "??",
                                        style: TextStyle(
                                          color: Theme.of(context)
                                              .secondaryHeaderColor,
                                          fontSize: 15.0,
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        book.categories[0] != "none" ? book.categories[0] : " ",
                                        style: TextStyle(
                                    ...
                                    Container(
                                      ...
                                      alignment: Alignment.center,
                                      child: Text(
                                        book.categories[1] == "none" ? book.categories[1] : " ",
                                        style: TextStyle(
