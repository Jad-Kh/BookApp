...
import '../widgets/add_screen_list.dart';

class AddListScreen extends StatefulWidget {
  UserList list;
  AddListScreen({required this.list});

  @override
  _AddListState createState() => _AddListState();
}

class _AddListState extends State<AddListScreen> {
  bool pressed = false;
  int searchType = 0;
            ...
            child: Container(
              ...
              child: ListView(
                children: [
                  ...
                  if (pressed) AddSearchList(search: _searchController.text, index: searchType, list: widget.list),
                ],
              ),
            ),
          )
